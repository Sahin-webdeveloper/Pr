                        ...
                        <article class="hentry">
                            ...
                            <div class="post-author clearfix">
                                <div class="author-avatar">
                                    <a href="#"><img src="/assets/img/news/author.jpg" alt="image" /></a>
                                </div>

                                <div class="author-desc">
                                    <h4 class="name">Michael Jordan</h4>
                                ...
                                <ol class="comment-list">
                                    <li class="comment">
                                        <article class="comment-wrap clearfix">
                                            <div class="gravatar"><img alt="image" src="/assets/img/news/user1.jpg" /></div>
                                            <div class="comment-content">
                                                <div class="comment-meta">
                                                    <h6 class="comment-author">Larry Bird</h6>
                                        ...
                                        <ul class="children">
                                            <li class="comment">
                                                <article class="comment-wrap clearfix">
                                                    <div class="gravatar"><img alt="image" src="/assets/img/news/author.jpg" /></div>
                                                    <div class="comment-content">
                                                        <div class="comment-meta">
                                                            <h6 class="comment-author">Michael Jordan</h6>
                                                            <span class="comment-time">12/30/2016</span>
                                                            <span class="comment-reply"><a class="comment-reply-link" href="#">Reply</a></span>
                                                        </div>
                                                        <div class="comment-text">
                                    ...
                                    <li class="comment">
                                        <article class="comment-wrap clearfix">
                                            <div class="gravatar"><img alt="image" src="/assets/img/news/user2.jpg" /></div>
                                            <div class="comment-content">
                                                <div class="comment-meta">
                                                    <h6 class="comment-author">Richard Clayderman</h6>
                                                    <span class="comment-time">12/30/2016</span>
                                                    <span class="comment-reply"><a class="comment-reply-link" href="#">Reply</a></span>
                                                </div>
                                                <div class="comment-text">
